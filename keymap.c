...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    LGUI_T(KC_Q), LT(1, KC_ESC),     LT(2, KC_SPC), LT(4, KC_P)
  ),
  ...
  [2] = LAYOUT(
    KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,    KC_LBRC,KC_RPRN,KC_LCBR,KC_RCBR,KC_DEL,
  ...
  [4] = LAYOUT(
    KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,     KC_KB_MUTE,KC_KB_VOLUME_DOWN,KC_KB_VOLUME_UP,KC_BSPC,
    KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,             KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,
